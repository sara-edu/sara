...
[Payment Link](https://rzp.io/i/L9pSEIHC)
...
- {{< fa atom >}} ***[Data Science for Under-Represented Communities in India.]{style="color:#008080"}***
    ...
    {{< fa clock >}} 22 JULY 5 PM IST (UTC+05:30).
...
- {{< fa user >}} **Dr. Samantha MacBride**, Adj Asst Professor, Baruch College, USA | [{{< fa brands linkedin >}}](https://www.linkedin.com/in/samantha-macbride-1664815/)
    ...
    {{< fa clock >}} 24 JULY 5 PM IST (UTC+05:30). 
...
- {{< fa atom >}} ***[Preparing for Higher Education Abroad.]{style="color:#008080"}***
    ...
    {{< fa clock >}} 24 JULY 9 AM IST (UTC+05:30). 
...
-  {{< fa atom >}} ***[Numbers, they are Part of our Everyday Life.]{style="color:#008080"}***
    ...
    {{< fa atom >}} ***Numbers, they're part of our everyday life.***

    {{< fa clock >}} 9 AM IST (UTC+05:30). 
...
- {{< fa user >}} **Dr. Deepak Malghan**, Assistant Professor, IIM Bangalore, IN | [{{< fa brands twitter >}}](https://x.com/deepak_malghan)
    ...
    {{< fa clock >}} 25 JULY 5 PM IST (UTC+05:30)
...
- {{< fa atom >}} ***[Scholarship with Soul: Crafting a Meaningful Academic Identity]{style="color:#008080"}.***
    ...
    {{< fa clock >}} 26 JULY 5 PM IST (UTC+05:30). 
